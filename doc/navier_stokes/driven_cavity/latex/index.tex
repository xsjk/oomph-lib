...
\hypertarget{index}{}\label{index}\index{Example problem: The 2D Driven Cavity Problem@{Example problem: The 2D Driven Cavity Problem}}
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_equation}{}\doxysection{\texorpdfstring{The Navier-\/\+Stokes equations}{The Navier-Stokes equations}}\label{index_equation}
...
The above equations are typically augmented by Dirichlet boundary conditions for (some of) the velocity components. On boundaries where no velocity boundary conditions are applied, the flow satisfies the "{}traction free"{} natural boundary condition  $ t_i = -p \, n_i + R_\mu (\partial u_i/\partial x_j + 
...
\DoxyHorRuler{0}
\hypertarget{index_CR}{}\doxysubsubsection{\texorpdfstring{Crouzeix-\/\+Raviart elements}{Crouzeix-Raviart elements}}\label{index_CR}
...
\DoxyHorRuler{0}
\hypertarget{index_TH}{}\doxysubsubsection{\texorpdfstring{Taylor-\/\+Hood elements}{Taylor-Hood elements}}\label{index_TH}
...
\DoxyHorRuler{0}
\hypertarget{index_params}{}\doxysection{\texorpdfstring{Non-\/dimensional parameters and their default values}{Non-dimensional parameters and their default values}}\label{index_params}
...
\hypertarget{index_results_CR}{}\doxysubsection{\texorpdfstring{Crouzeix-\/\+Raviart elements}{Crouzeix-Raviart elements}}\label{index_results_CR}
...
\end{DoxyImage}
\hypertarget{index_results_TH}{}\doxysubsection{\texorpdfstring{Taylor-\/\+Hood elements}{Taylor-Hood elements}}\label{index_results_TH}
...
Note that in both simulations, the flow field is clearly under-\/resolved near the ends of the "{}lid"{}. In \href{../../adaptive_driven_cavity/html/index.html}{\texttt{ another example}} we will demonstrate the use of spatial adaptivity to obtain much better solutions for this problem.
...
\end{DoxyCodeInclude}
 Next we pass a pointer to the Reynolds number (stored in {\ttfamily \doxylink{namespaceGlobal__Physical__Variables_ab814e627d2eb5bc50318879d19ab16b9}{Global\+\_\+\+Physical\+\_\+\+Variables\+::\+Re}}) to all elements.
...
\hypertarget{index_stress_divergence}{}\doxysubsection{\texorpdfstring{The stress-\/divergence form}{The stress-divergence form}}\label{index_stress_divergence}
