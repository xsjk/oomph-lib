\chapter{Demo problem\+: The static free surface bounding a layer of viscous fluid.}
\hypertarget{index}{}\label{index}\index{Demo problem: The static free surface bounding a layer of viscous fluid.@{Demo problem: The static free surface bounding a layer of viscous fluid.}}
\hypertarget{index_overview}{}\doxysection{\texorpdfstring{Overview of the problem}{Overview of the problem}}\label{index_overview}
...
\end{DoxyEnumerate}\hypertarget{index_vol_const}{}\doxysection{\texorpdfstring{Enforcing the volume constraint}{Enforcing the volume constraint}}\label{index_vol_const}
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_global}{}\doxysection{\texorpdfstring{Problem Parameters}{Problem Parameters}}\label{index_global}
...
\end{DoxyCodeInclude}
 \hypertarget{index_elements}{}\doxysection{\texorpdfstring{Creating the additional elements}{Creating the additional elements}}\label{index_elements}
\hypertarget{index_free}{}\doxysubsection{\texorpdfstring{Free surface elements}{Free surface elements}}\label{index_free}
The free surface elements are created in exactly the same way as in \href{../../single_layer_free_surface/html/index.html}{\texttt{ another tutorial }}. The only difference is that the construction takes place within the function {\ttfamily create\+\_\+free\+\_\+surface\+\_\+elements()} rather than within the constructor directly.\hypertarget{index_vol}{}\doxysubsection{\texorpdfstring{Volume constraint elements}{Volume constraint elements}}\label{index_vol}
...
\end{DoxyCodeInclude}
 \hypertarget{index_contact}{}\doxysubsection{\texorpdfstring{Contact angle elements}{Contact angle elements}}\label{index_contact}
...
\hypertarget{index_com}{}\doxysubsection{\texorpdfstring{Comments}{Comments}}\label{index_com}
