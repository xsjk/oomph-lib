...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00038}00038\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\&\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{a}},}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00039}00039\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\&\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{h}},}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00040}00040\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\&\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{azimuthal\_fraction}},}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00041}00041\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\&\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{phi}})}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00044}00044\ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{Ellipse}}\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{ellipse}}(\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{a}},\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{a}});}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00047}00047\ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{Vector<double>}}\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi}}(1);}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00048}00048\ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{Vector<double>}}\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{base}}(2);}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00049}00049\ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{Vector<double>}}\ N(2);}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00050}00050\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{unsigned}\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{n\_node}}\ =\ this-\/>\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nnode}}();}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00054}00054\ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{Node}}*\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}\ =\ this-\/>\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{node\_pt}}(\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{n}});}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00059}00059\ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi}}[0]\ =\ (1.0\ -\/\ 1.0e-\/10)\ *\ (-\/\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{azimuthal\_fraction}}\ *\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>x(0))\ *\ 2.0\ *}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00062}00062\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (1.0\ -\/\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{azimuthal\_fraction}})\ *\ 2.0\ *\ MathematicalConstants::Pi;}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00065}00065\ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi}}[0]\ +=\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{phi}};}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00068}00068\ \ \ \ \ \ \ \textcolor{keywordtype}{double}\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{w}}\ =\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>x(1);}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00071}00071\ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{ellipse}}.position(\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi}},\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{base}});}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00075}00075\ \ \ \ \ \ \ N[0]\ =\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{base}}[0]\ /\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{norm}};}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00076}00076\ \ \ \ \ \ \ N[1]\ =\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{base}}[1]\ /\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{norm}};}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00083}00083\ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{Vector<double>}}\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi\_bound}}(1);}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00086}00086\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>is\_on\_boundary(0))}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00087}00087\ \ \ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00088}00088\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi\_bound}}[0]\ =\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{atan2}}(\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>x(1),\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>x(0));}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00089}00089\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>set\_coordinates\_on\_boundary(0,\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi\_bound}});}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00093}00093\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>is\_on\_boundary(1))}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00096}00096\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>set\_coordinates\_on\_boundary(1,\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi\_bound}});}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00100}00100\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>is\_on\_boundary(2))}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00101}00101\ \ \ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00102}00102\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi\_bound}}[0]\ =\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{atan2}}(\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>x(1),\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>x(0));}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00103}00103\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>set\_coordinates\_on\_boundary(2,\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi\_bound}});}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00107}00107\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>is\_on\_boundary(3))}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00108}00108\ \ \ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00109}00109\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi\_bound}}[0]\ =\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{sqrt}}(\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{pow}}(\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>x(0),\ 2)\ +\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{pow}}(\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>x(1),\ 2));}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00110}00110\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{nod\_pt}}-\/>set\_coordinates\_on\_boundary(3,\ \mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{xi\_bound}});}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00114}00114\ \ \ \ \ this-\/>\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{Boundary\_coordinate\_exists}}[0]\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00115}00115\ \ \ \ \ this-\/>\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{Boundary\_coordinate\_exists}}[1]\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00116}00116\ \ \ \ \ this-\/>\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{Boundary\_coordinate\_exists}}[2]\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00117}00117\ \ \ \ \ this-\/>\mbox{\hyperlink{classoomph_1_1GeompackQuadMesh}{Boundary\_coordinate\_exists}}[3]\ =\ \textcolor{keyword}{true};}
