...
\begin{DoxyItemize}
\item \doxysectlink{index_comp_opt}{How do I specify different levels of optimisation and/or non-\/standard compiler options?}{2} ~\newline
~\newline

\item \doxysectlink{index_cpp11}{My compiler doesn\textquotesingle{}t support C++11 by default}{2} ~\newline
~\newline

\item \doxysectlink{index_other_compilers}{The compilation fails when I use my xxx \mbox{[}non gcc\mbox{]} compiler}{2} ~\newline
~\newline

\item \doxysectlink{index_cygwin}{The build process fails under cygwin}{2} ~\newline
~\newline

\item \doxysectlink{index_apple}{The build process fails under Apple\textquotesingle{}s Darwin (OSX) or other BSD Linux distributions}{2} ~\newline
~\newline

\item \doxysectlink{index_apple_link}{The linking self-\/test fails under Apple\textquotesingle{}s OSX}{2} ~\newline
~\newline

\item \doxysectlink{index_self_tests}{Some of the self tests fail}{2} ~\newline
~\newline

\item \doxysectlink{index_run1}{How do I compile/run the demo driver codes?}{2} ~\newline
~\newline

\item \doxysectlink{index_run2}{Why doesn\textquotesingle{}t make make anything? What are the targets called?}{2} ~\newline
~\newline

\item \doxysectlink{index_only_compile_dont_run}{Running the self-\/tests takes a long time. Is it possible to suppress the execution of the built driver codes and only check if they compile? (Mainly useful for developers).}{2} ~\newline
~\newline

\item \doxysectlink{index_grep_run}{I only want to run the self-\/tests for demo driver codes that contain a certain string (typically a class name; again mainly useful for developers)}{2} ~\newline
~\newline

\item \doxysectlink{index_link}{The oomph-\/lib distribution includes some third-\/party libraries. How do I get the code to link against optimised local versions of these libraries that are already installed on my machine?}{2} ~\newline
~\newline
...
\item \doxysectlink{index_build_not_run_demos}{How do I build the self tests without running them?}{2} ~\newline
~\newline
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_installation}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{index_installation}
\hypertarget{index_comp_opt}{}\doxysubsection{\texorpdfstring{How do I specify different levels of optimisation and/or non-\/standard compiler options?}{How do I specify different levels of optimisation and/or non-standard compiler options?}}\label{index_comp_opt}
...
\DoxyHorRuler{0}
\hypertarget{index_cpp11}{}\doxysubsection{\texorpdfstring{My compiler doesn\textquotesingle{}t support C++11 by default}{My compiler doesn't support C++11 by default}}\label{index_cpp11}
...
\DoxyHorRuler{0}
\hypertarget{index_other_compilers}{}\doxysubsection{\texorpdfstring{The compilation fails when I use my xxx \mbox{[}non gcc\mbox{]} compiler}{The compilation fails when I use my xxx [non gcc] compiler}}\label{index_other_compilers}
...
\DoxyHorRuler{0}
\hypertarget{index_cygwin}{}\doxysubsection{\texorpdfstring{The build process fails under cygwin}{The build process fails under cygwin}}\label{index_cygwin}
...
\DoxyHorRuler{0}
\hypertarget{index_apple}{}\doxysubsection{\texorpdfstring{The build process fails under Apple\textquotesingle{}s Darwin (\+OSX) or other BSD Linux distributions}{The build process fails under Apple's Darwin (OSX) or other BSD Linux distributions}}\label{index_apple}
...
\hypertarget{index_apple_link}{}\doxysubsection{\texorpdfstring{The linking self-\/test fails under Apple\textquotesingle{}s OSX}{The linking self-test fails under Apple's OSX}}\label{index_apple_link}
...
\DoxyHorRuler{0}
\hypertarget{index_self_tests}{}\doxysubsection{\texorpdfstring{Some of the self tests fail}{Some of the self tests fail}}\label{index_self_tests}
...
\DoxyHorRuler{0}
\hypertarget{index_run1}{}\doxysubsection{\texorpdfstring{How do I compile/run the demo driver codes?}{How do I compile/run the demo driver codes?}}\label{index_run1}
...
~\newline
 \DoxyHorRuler{0}
\hypertarget{index_run2}{}\doxysubsection{\texorpdfstring{Why doesn\textquotesingle{}t make make anything? What are the targets called?}{Why doesn't make make anything? What are the targets called?}}\label{index_run2}
...
\DoxyHorRuler{0}
\hypertarget{index_only_compile_dont_run}{}\doxysubsection{\texorpdfstring{Running the self-\/tests takes a long time. Is it possible to suppress the execution of the built driver codes and only check if they compile? (\+Mainly useful for developers).}{Running the self-tests takes a long time. Is it possible to suppress the execution of the built driver codes and only check if they compile? (Mainly useful for developers).}}\label{index_only_compile_dont_run}
...
\DoxyHorRuler{0}
\hypertarget{index_grep_run}{}\doxysubsection{\texorpdfstring{I only want to run the self-\/tests for demo driver codes that contain a certain string (typically a class name; again mainly useful for developers)}{I only want to run the self-tests for demo driver codes that contain a certain string (typically a class name; again mainly useful for developers)}}\label{index_grep_run}
The script 
\begin{DoxyCode}{0}
...
\DoxyHorRuler{0}
\hypertarget{index_link}{}\doxysubsection{\texorpdfstring{The oomph-\/lib distribution includes some third-\/party libraries. How do I get the code to link against optimised local versions of these libraries that are already installed on my machine?}{The oomph-lib distribution includes some third-party libraries. How do I get the code to link against optimised local versions of these libraries that are already installed on my machine?}}\label{index_link}
To facilitate the installation, the oomph-\/lib distribution includes the relevant parts of certain third-\/party libraries, such as \href{http://crd.lbl.gov/~xiaoye/SuperLU}{\texttt{ Super\+LU}} and \href{http://www.netlib.org/blas/}{\texttt{ BLAS}}. These "{}external libraries"{} are built and installed along with {\ttfamily oomph-\/lib\textquotesingle{}s} own sub-\/libraries. To distinguish them from any already existing local versions of these libraries, their names are pre-\/fixed with the string {\ttfamily oomph\+\_\+}.
...
\DoxyCodeLine{\textcolor{preprocessor}{\#}}
\DoxyCodeLine{EXTERNAL\_LIBS=\textcolor{stringliteral}{'-\/loomph\_hsl\ -\/loomph\_superlu\_3.0\ -\/loomph\_metis\_4.0\ -\/loomph\_lapack\ -\/loomph\_flapack\ -\/loomph\_blas'}}
...
~\newline
~\newline
 \hypertarget{index_build_not_run_demos}{}\doxysubsection{\texorpdfstring{How do I build the self tests without running them?}{How do I build the self tests without running them?}}\label{index_build_not_run_demos}
